...
L["Options"] = "Options"
L["Help"] = "Aide"
L["Team Online Check"] = "Vérifier si l'équipe est connectée"
L["Assume All Team Members Always Online"] = "Toujours supposer que l'équipe est en ligne"
L["Boost Jamba to Jamba Communications**"] = "Booster les échanges internes à Jamba"
L["**reload UI to take effect, may cause disconnections"] = "Changement visible après un /reloadUI, peut provoquer des déconnections"
end
