...
Config.Riding            = true -- Learn riding
Config.ApprenticeRiding  = true -- Learn apprentice riding
Config.JourneymanRiding  = true -- Learn journeyman riding
Config.ExpertRiding      = true -- Learn expert riding
Config.ArtisanRiding     = true -- Learn artisan riding
Config.ColdWeatherFlying = true -- Learn cold weather flying
