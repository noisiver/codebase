...
-- (@Entry+1, 3, 62, @GossipMenu+1, 3, 62, 1, 7, 1659.147, -4428.456, 17.368, 2.008, 'Zackary Aries - OnGossipSelect - Teleport to Orgrimmar'),
-- (@Entry+1, 4, 62, @GossipMenu+1, 4, 62, 1, 7, -1273.327, 71.340, 128.020, 5.992, 'Zackary Aries - OnGossipSelect - Teleport to Thunder Bluff'),
-- (@Entry+1, 5, 62, @GossipMenu+1, 5, 62, 0, 7, 1595.664, 220.437, -57.161, 4.670, 'Zackary Aries - OnGossipSelect - Teleport to Undercity'),
-- (@Entry+1, 6, 62, @GossipMenu+1, 6, 62, 530, 7, 9514.708, -7265.375, 14.341, 4.967, 'Zackary Aries - OnGossipSelect - Teleport to Silvermoon City');
