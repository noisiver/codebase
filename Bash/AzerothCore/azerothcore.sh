        ...
        <modules>
            ...
            <recruit_a_friend>
                ...
                <rewards>
                    ...
                    <swift_zhevra>${98:-true}</swift_zhevra>
                    <!-- Give the X-53 Touring Rocket item as a reward -->
                    <touring_rocket>${99:-true}</touring_rocket>
                </rewards>
            </recruit_a_friend>
            <skip_dk_starting_area>
                ...
                <starting_level>${101:-58}</starting_level>
            </skip_dk_starting_area>
            <spawn_points>
            ...
            <weekend_bonus>
                ...
                <experience_multiplier>${104:-2}</experience_multiplier>
                <!-- The multiplier for money looted and rewarded from quests on weekends -->
                <money_multiplier>${105:-2}</money_multiplier>
                <!-- The multiplier for profession skill ups on weekends -->
                <professions_multiplier>${106:-2}</professions_multiplier>
                <!-- The multiplier for reputation on weekends -->
                <reputation_multiplier>${107:-2}</reputation_multiplier>
                <!-- The multiplier for weapons and defense skill ups on weekends -->
                <proficiencies_multiplier>${108:-2}</proficiencies_multiplier>
            </weekend_bonus>
        </modules>
...
function load_options
{
    ...
    if [[ ! $OPTION_MODULES_SKIP_DK_STARTING_AREA_STARTING_LEVEL =~ ^[0-9]+$ ]] || [[ $OPTION_MODULES_SKIP_DK_STARTING_AREA_STARTING_LEVEL < 1 || $OPTION_MODULES_SKIP_DK_STARTING_AREA_STARTING_LEVEL > 80 ]]; then
        ...
        OPTION_MODULES_SKIP_DK_STARTING_AREA_ENABLED="58"
        RESET=true
    fi
