...
function set_config
{
    ...
    sed -i 's/Warden.Enabled =.*/Warden.Enabled = 0/g' $ROOT/source/azerothcore/etc/worldserver.conf
    ...
    sed -i 's/Progression.QuestInfo.Enforced =.*/Progression.QuestInfo.Enforced = 0/g' $ROOT/source/azerothcore/etc/worldserver.conf
