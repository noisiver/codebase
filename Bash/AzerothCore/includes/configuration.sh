        ...
        <module>
            ...
            <assistant>
                ...
                <spawn_point>
                    ...
                    <enable_death_knight>${83:-false}</enable_death_knight>
                </spawn_point>
                ...
                <activate_zone>${85:-false}</activate_zone>
            </assistant>
            <eluna>
