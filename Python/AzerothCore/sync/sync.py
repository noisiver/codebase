...
# database (1 = characters, 2 = world), table name, procedure, delete queries
data_tables = [
    [
        1,
        'active_arena_season',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'Patch\' AND TABLE_NAME=\'active_arena_season\')) THEN\n        ALTER TABLE `active_arena_season`\n            ADD COLUMN `Patch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `season_state`,\n            ADD PRIMARY KEY (`season_id`, `Patch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
    ...
    [
        ...
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'disenchant_loot_template\')) THEN\n        ALTER TABLE `disenchant_loot_template`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `Comment`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`Entry`, `Item`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        ''
    ],
    [
        2,
    ...
    [
        ...
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'gameobject_questender\')) THEN\n        ALTER TABLE `gameobject_questender`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `quest`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`id`, `quest`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        ''
    ],
    [
        2,
    ...
    [
        2,
        'item_template',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'Patch\' AND TABLE_NAME=\'item_template\')) THEN\n        ALTER TABLE `item_template`\n            ADD COLUMN `Patch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `entry`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`entry`, `Patch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
    ...
    [
        2,
        'mail_loot_template',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'mail_loot_template\')) THEN\n        ALTER TABLE `mail_loot_template`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `Comment`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`Entry`, `Item`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        ''
    ],
    [
        2,
        'milling_loot_template',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'milling_loot_template\')) THEN\n        ALTER TABLE `milling_loot_template`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `Comment`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`Entry`, `Item`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        ''
    ],
    [
        2,
        'npc_text',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'Patch\' AND TABLE_NAME=\'npc_text\')) THEN\n        ALTER TABLE `npc_text`\n            ADD COLUMN `Patch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `ID`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`ID`, `Patch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        'DELETE FROM `npc_text` WHERE `ID`=5480;'
    ],
    [
        2,
        'npc_trainer',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'npc_trainer\')) THEN\n        ALTER TABLE `npc_trainer`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `ReqSpell`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`ID`, `SpellID`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        'DELETE FROM `npc_trainer` WHERE `SpellID` IN (1066, 1710, 10847, 13820, 18249, 21562, 21564, 21849, 21850, 23028, 23161, 23214, 25286, 25288, 25289, 25290, 25291, 25292, 25294, 25295, 25296, 25297, 25298, 25299, 25300, 25302, 25304, 25306, 25307, 25309, 25311, 25314, 25315, 25316, 25345, 25357, 25361, 25392, 25782, 25894, 25898, 25899, 25916, 25918, 26991, 27090, 27127, 27683, 28609, 28610, 28612, 29228, 31016, 31018, 31709, 31789, 33388, 33391, 33717, 33950, 34090, 34767, 34768, 36936, 39374, 53042, 54083, 62124, 63742, 63743, 63746, 63750, 64725, 64726, 64727, 64728, 66842, 66843, 66844);\nDELETE FROM `npc_trainer` WHERE ((`ReqLevel` > 60 AND `ReqLevel` <= 70) OR (`ReqSkillRank` > 300 AND `ReqSkillRank` <= 375)) AND `SpellID` NOT IN (1710, 10847, 13820, 18249, 21562, 21564, 21849, 21850, 23028, 23161, 23214, 25782, 25894, 25898, 25899, 25916, 25918, 27681, 33388, 33391, 33950, 34090, 34767, 34768, 36936, 53042, 54083, 63742, 63743, 63746, 63750, 64725, 64726, 64727, 64728, 66842, 66843, 66844);\nDELETE FROM `npc_trainer` WHERE ((`ReqLevel` > 70 OR `ReqSkillRank` > 375) AND `SpellID` NOT IN (1710, 10847, 13820, 18249, 21562, 21564, 21849, 21850, 23028, 23161, 23214, 25782, 25894, 25898, 25899, 25916, 25918, 27681, 33388, 33391, 33950, 34090, 34767, 34768, 36936, 53042, 54083, 63742, 63743, 63746, 63750, 64725, 64726, 64727, 64728, 66842, 66843, 66844));'
    ],
    [
        2,
        'npc_vendor',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'npc_vendor\')) THEN\n        ALTER TABLE `npc_vendor`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `VerifiedBuild`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`entry`, `item`, `ExtendedCost`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
    ...
    [
        ...
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'player_loot_template\')) THEN\n        ALTER TABLE `player_loot_template`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `Comment`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`Entry`, `Item`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        ''
    ],
    [
        2,
    ...
    [
        ...
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'prospecting_loot_template\')) THEN\n        ALTER TABLE `prospecting_loot_template`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `Comment`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`Entry`, `Item`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        ''
    ],
    [
        2,
    ...
    [
        2,
        'quest_template',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'Patch\' AND TABLE_NAME=\'quest_template\')) THEN\n        ALTER TABLE `quest_template`\n            ADD COLUMN `Patch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `ID`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`ID`, `Patch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
    ...
    [
        2,
        'spell_loot_template',
        'DELIMITER $$\nDROP PROCEDURE IF EXISTS AddColumn $$\nCREATE PROCEDURE AddColumn()\nBEGIN\n    IF NOT EXISTS((SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND COLUMN_NAME=\'MinPatch\' AND TABLE_NAME=\'spell_loot_template\')) THEN\n        ALTER TABLE `spell_loot_template`\n            ADD COLUMN `MinPatch` INT UNSIGNED NOT NULL DEFAULT \'0\' AFTER `Comment`,\n            ADD COLUMN `MaxPatch` INT UNSIGNED NOT NULL DEFAULT \'21\' AFTER `MinPatch`,\n            DROP PRIMARY KEY,\n            ADD PRIMARY KEY (`Entry`, `Item`, `MinPatch`, `MaxPatch`) USING BTREE;\n    END IF;\nEND $$\nCALL AddColumn()\n$$\nDELIMITER ;\nDROP PROCEDURE IF EXISTS AddColumn;\n',
        ''
    ],
    [
        2,
...
def CreateBaseFiles():
    ...
    for table in data_tables:
        ...
        try:
            ...
            file = open(f'{cwd}/export/{'characters' if type == 1 else 'world'}/progression_{name}.sql', 'w')
            file.write(data)
            file.close()
        except:
...
def ExportData():
    ...
    for table in data_tables:
        ...
        try:
            ...
            if len(content) > 0:
                with open(f'{cwd}/export/{'characters' if type == 1 else 'world'}/progression_{name}.sql', 'a') as file:
                    file.write(content)
        except:
...
def ImportExportedData():
    ...
    PrintHeader('Finished importing generated data')
